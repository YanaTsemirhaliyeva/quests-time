import { DEFAULT_CONTACT_ADDRESS, NavigationStatus, PageMapClass } from '../../const';
import Map from '../../components/map/map';
import Layout from '../../components/layout/layout';

function ContactsScreen(): JSX.Element {
  return (
    <Layout navigation={NavigationStatus.WithoutBookings} pageTitle='Контакты'>
        ...
        <div className="container">
          ...
          <div className="contacts">
            ...
            <div className="contacts__map">
              <Map page={PageMapClass.Contacts} contacts={DEFAULT_CONTACT_ADDRESS} />
            </div>
          </div>
        </div>
      </main>
